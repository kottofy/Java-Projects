...
public class Vehicles
{
    public static void main (String[] args)
    {
        ...
        /* The following String and char are set to default so they can
        ...
        while(!userOption.equalsIgnoreCase("q"))
        {
            ...
            /* The following if statements will call specific methods depending
             on that user's option choice*/
            ...
            // the following if statement displays the help message
        ...
        // if the user enters 'q' for quit, then the program will terminate
        if (userOption.equalsIgnoreCase("q"))
           System.exit(0);
    }

    /*****  The following methods are declared private because they are only
     * used in this class. They are also declared static so they can be used
     * in the main class.   ***********/

    /*getVehicleType uses the instanceof operator to determine if the vehicle
    passed is of a certain type and prints the type*/
    private static void getVehicleType(Vehicle vehicles)
    {
    ...
    /*printOption1 uses the static variable countOfVehicles to display the
    number of vehicles in the system */
   private static void printOption1(Vehicle[] vehicles)
   {
        System.out.println("The number of vehicles in the system: " + Vehicle.countOfVehicles);
   }

   /*printOption2 prints the names and types of each vehicle in the system by
    using a for loop to go through all the vehicles and by calling the
    method getVehicleType which displays the type*/
    private static void printOption2(Vehicle[] vehicles)
    {
    ...
    /* printOption3 prints which vehicles can fly by using a for loop and the
     * instance of operator to go through each of the vehicles and using the
     getVehicleType method to print the type*/
    ...
    /* printOption4 displays which vehicles can float by using a for loop
     and the instanceof variable to loop through each vehicle and also
     calls the method getVehicleType to print the type */
    ...
    /* printOption5 displays which vehicles can float and fly by using a for
     loop and the instanceof operator to go through each vehicle in the
     system and also calls the getVehicleType method that displays the type*/
    ...
    /* printOption6 prints a description of all vehicles by using a for loop
     to go through each vehicle and the instanceof operator to determine
     what attributes will need to be displayed for what type of vehicle*/
