 ...
 */
public class LinkedListTester1 extends TestCase {
     ...
     * The name argument is the name of a test case (see the suite() method).
     * @param name
     */
    public LinkedListTester1(String name) {
        super(name);
    }

    /**
     * Step 3. Create a setUp() method to instantiate and initialize the
     * object under test. This method is invoked before EVERY test case.
     * Testing add method.
     * Edited: changed add methods for testing purposes.
     */
...
//		list.add(2, C);
    ...
    */
    ...
    /**
       Test Case 2: Verifies the add() ops done in setUp().
     * Also tests the index Of method.
    */
    ...
    */
    ...
    public static Test suite() {
        ...
        // Java's reflection mechanism.
		   return new TestSuite(LinkedListTester1.class);
...
//        return suite;
    ...
    //    String[] TestCaseName = {LinkedListTester1.class.getName()};
