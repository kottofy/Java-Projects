...
public class LinkedList<E> extends AbstractSequentialList<E> implements Serializable {
    ...
    */
    ...
    public E remove(int index) throws IndexOutOfBoundsException
    {
        ...
        size--;     //decrease the size since a node was removed
        modCount++; //increase modCount since a modification was made
     ...
     */
    public Object[] toArray()       //SHOULD HEAD AND TAIL BE IN ARRAY ALSO???
    {
        //declare the array to convert the list to
        Object[] array = new Object[size];

        //create a temporary node
        DLNode<E> temp = head.getSuccessor();

        //loop through array and list to assign references to the array
        for (int i = 0; i < size; i++)
        {
            array[i] = temp;
            temp = temp.getSuccessor();
